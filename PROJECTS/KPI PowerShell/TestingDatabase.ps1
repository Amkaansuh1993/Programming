...
$smtpPort = 587,
$toEmail = "manu.dak@gmail.com",
$fromEmail = "manu.dak@gmail.com",
$subject = "Script Failure Notification",
$body = "The script has encountered an error and failed."
)
Send-MailMessage -From $fromEmail -To $toEmail -Subject $subject -Body $body -Priority High -DeliveryNotificationOption OnSuccess, OnFailure -SmtpServer $smtpServer -UseSsl -Credential "manu.dak@gmail.com"